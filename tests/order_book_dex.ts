...
describe("order_book_dex", () => {
  ...
  it("Realloc Market Pointer to fix bug", async () => {
    ...
    const b1 = await program.provider.connection.getAccountInfo(new PublicKey("5cUypf4qPyVgBTyt5GdwZzTCJ46zvtzmkAQM5mCqJufR"));
    const account1 = await program.account.orderPositionConfig.fetch(new PublicKey("5cUypf4qPyVgBTyt5GdwZzTCJ46zvtzmkAQM5mCqJufR"));
    ...
    const tx = await program.methods
      .reallocPositionConfig()
      .accountsStrict({
        signer: wallet.publicKey,
        orderBookConfig: new PublicKey("9nQrpEf5Q3K8wRQ8xo2ffzWHEacR3yqz5QZj2jCBWmsn"),
        orderPositionConfig: new PublicKey("5cUypf4qPyVgBTyt5GdwZzTCJ46zvtzmkAQM5mCqJufR"),
    ...
    const account2 = await program.account.orderPositionConfig.fetch(new PublicKey("5cUypf4qPyVgBTyt5GdwZzTCJ46zvtzmkAQM5mCqJufR"));
    console.log(b2)
